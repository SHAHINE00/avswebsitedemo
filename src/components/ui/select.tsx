...
import { useIsAndroid } from "@/hooks/use-mobile-simple"
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        isAndroid && "min-h-[48px] text-base",
  ...
  return (
    <SelectPrimitive.Portal>
      ...
      >
        ...
        <SelectPrimitive.Viewport className="p-1 h-[var(--radix-select-trigger-height)] w-full min-w-full">
          {children}
