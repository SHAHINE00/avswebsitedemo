...
const ProgramGoalsSection = () => {
  const programGoals = [
    ...
    },
    {
      ...
      details: "Permettre l'adaptation à différents secteurs et rôles dans l'écosystème du développement logiciel"
    }
  ];
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Quatre piliers fondamentaux pour votre réussite professionnelle en Programmation
          </p>
        </div>
