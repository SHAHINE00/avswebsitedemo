...
import { BookOpen, Target, Award, Code, Database, GraduationCap, ArrowRight } from 'lucide-react';
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Explorez chaque section de notre programme complet de programmation
          </p>
        </div>
                  ...
                  >
                    <div className="flex items-center space-x-6">
                      <div className="flex-shrink-0">
                        <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-academy-purple to-academy-blue flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                      ...
                      <div className="flex-shrink-0">
                        <ArrowRight className="w-6 h-6 text-gray-400 group-hover:text-academy-purple transition-all duration-300 transform group-hover:translate-x-1" />
                      </div>
                    </div>
                  </a>
                </CardContent>
