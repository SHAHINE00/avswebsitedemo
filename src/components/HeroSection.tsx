      ...
      <div className="container mx-auto px-6 flex flex-col md:flex-row items-center">
        <div className="md:w-1/2 mb-10 md:mb-0">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6">
            Become an <span className="gradient-text">AI Technician Specialist</span>
          </h1>
          <p className="text-lg md:text-xl text-gray-700 mb-8 max-w-lg">
            Master cutting-edge AI technologies with our comprehensive training program. 
            Join thousands of successful graduates in the rapidly growing AI industry.
          </p>
