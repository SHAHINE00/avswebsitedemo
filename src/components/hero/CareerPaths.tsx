      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-6 sm:mb-8">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-2 sm:mb-3 bg-gradient-to-r from-academy-blue to-academy-purple bg-clip-text text-transparent">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-6 sm:mb-8">
            ...
            <div className="group relative bg-card rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-lg border border-academy-blue/10 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
            ...
            <div className="group relative bg-card rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-lg border border-academy-purple/10 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
            ...
            <div className="group relative bg-card rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-lg border border-academy-lightblue/10 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 sm:col-span-2 lg:col-span-1">
