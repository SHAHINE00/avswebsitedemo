    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 mt-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          ...
          <div className="feature-card bg-white p-4 sm:p-5 rounded-lg border border-gray-200 hover:border-academy-blue transition-all flex items-center min-h-[60px] touch-manipulation sm:col-span-2 lg:col-span-1">
            <span className="text-2xl sm:text-3xl mr-3 sm:mr-4 flex-shrink-0">💼</span>
