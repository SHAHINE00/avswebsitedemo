  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Gérez l'horaire récurrent et les séances du cours</CardDescription>
      </CardHeader>
      <CardContent>
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          <TabsList className="grid w-full grid-cols-2 mb-6">
            <TabsTrigger value="schedules">Horaires récurrents</TabsTrigger>
            <TabsTrigger value="all-sessions">Toutes les séances</TabsTrigger>
          </TabsList>
          ...
          <TabsContent value="schedules" className="space-y-4">
            ...
            {loading ? (
              ...
              <p className="text-center text-muted-foreground py-8">Aucune plage horaire définie</p>
            ) : (
          ...
          <TabsContent value="all-sessions">
            <AllSessionsView courseId={courseId} />
          </TabsContent>
        </Tabs>
      </CardContent>
    </Card>
