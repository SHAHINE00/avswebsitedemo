      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
          ...
          <Card className="relative overflow-hidden bg-gradient-to-br from-academy-blue/5 via-academy-purple/5 to-academy-lightblue/5 border-2 border-academy-blue/20">
            <div className="absolute top-0 right-0 bg-academy-blue text-white px-6 py-2 rounded-bl-2xl">
              <span className="font-semibold">Meilleure Valeur</span>
            </div>
            <CardHeader className="pb-6 pt-12">
              <CardTitle className="text-center">
                <div className="flex items-center justify-center mb-4">
                  <div className="bg-academy-blue/20 p-4 rounded-2xl">
                    <CreditCard className="w-10 h-10 text-academy-blue" />
                  </div>
                </div>
                <h3 className="text-2xl font-bold bg-gradient-to-r from-academy-blue via-academy-purple to-academy-lightblue bg-clip-text text-transparent">
            ...
            <CardContent className="space-y-6">
              <div className="text-center space-y-4">
                <div className="bg-academy-blue/10 rounded-xl p-4">
                  <div className="flex items-center justify-between">
                    <span className="text-gray-700">Frais d'inscription</span>
                    <span className="text-2xl font-bold text-academy-blue">1,000 MAD</span>
                  </div>
                </div>
                
                <div className="bg-academy-purple/10 rounded-xl p-4">
                  <div className="flex items-center justify-between">
                    <span className="text-gray-700">Versement mensuel</span>
                    <span className="text-2xl font-bold text-academy-purple">1,400 MAD</span>
                  </div>
                  <div className="text-sm text-gray-600 mt-1">× 20 mois</div>
                </div>
                
                <div className="bg-academy-lightblue/10 rounded-xl p-6 border-2 border-academy-lightblue/30">
                  <div className="flex items-center justify-between">
                    <span className="text-lg font-semibold text-gray-800">Investissement total</span>
                    <span className="text-4xl font-bold text-academy-lightblue">29,000 MAD</span>
                  </div>
                </div>
              </div>
              
              <div className="pt-4">
                <Button asChild className="w-full h-14 text-lg bg-gradient-to-r from-academy-blue via-academy-purple to-academy-lightblue hover:opacity-90">
          ...
          <Card className="bg-gradient-to-br from-white to-gray-50 border-gray-200">
            <CardHeader>
              <CardTitle className="flex items-center text-2xl text-gray-800">
                <CheckCircle className="w-8 h-8 mr-3 text-academy-blue" />
            ...
            <CardContent className="space-y-4">
              {included.map((item, index) => (
                <div key={index} className="flex items-start space-x-3 p-3 bg-academy-blue/5 rounded-lg">
                  <div className="bg-academy-blue/20 p-1 rounded-full mt-1">
                    <CheckCircle className="w-4 h-4 text-academy-blue" />
                  </div>
                  <span className="text-gray-700 font-medium">{item}</span>
                </div>
              ))}
              
              <div className="mt-6 p-4 bg-gradient-to-r from-academy-blue/10 to-academy-purple/10 rounded-xl border border-academy-blue/20">
                <h4 className="font-bold text-gray-800 mb-2">Valeur Exceptionnelle</h4>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <Card className="bg-gradient-to-br from-academy-lightblue/5 to-academy-lightblue/10 border-academy-lightblue/20">
            <CardHeader>
              <CardTitle className="flex items-center text-2xl text-academy-lightblue">
