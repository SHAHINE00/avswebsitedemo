              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {aiDomains.map((domain, index) => (
                    <div key={index} className="flex items-start space-x-3 p-4 bg-academy-blue/5 rounded-lg border border-academy-blue/20">
                    ...
                    <Card key={index} className="bg-gradient-to-br from-academy-blue/5 to-academy-blue/10 border-academy-blue/20">
                      <CardContent className="p-6">
                        <div className="flex items-center mb-4">
                          <Badge className="bg-academy-blue text-white mr-3">
                            Semestre {semester.semester}
                          </Badge>
                          <h3 className="text-xl font-bold text-academy-blue">{semester.title}</h3>
                        </div>
