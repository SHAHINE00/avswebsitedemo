    ...
    <SectionWrapper background="white" padding="xl">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <Badge variant="outline" className="mb-4 text-lg px-4 py-2 bg-academy-lightblue/10 text-academy-lightblue border-academy-lightblue/30">
          ...
          <Card className="group hover:shadow-2xl transition-all duration-500 bg-gradient-to-br from-academy-blue/5 to-academy-blue/10 border-academy-blue/20">
            ...
            <CardContent className="space-y-4">
              {aiCertifications.map((cert, index) => (
                <div key={index} className="flex items-start space-x-3 p-4 bg-white/60 rounded-lg border border-academy-blue/10 hover:border-academy-blue/30 transition-colors">
                  <div className="bg-academy-blue/20 p-2 rounded-full mt-1">
                    <Globe className="w-4 h-4 text-academy-blue" />
                  </div>
          ...
          <Card className="group hover:shadow-2xl transition-all duration-500 bg-gradient-to-br from-academy-purple/5 to-academy-purple/10 border-academy-purple/20">
            ...
            <CardContent className="space-y-4">
              {programmingCertifications.map((cert, index) => (
                <div key={index} className="flex items-start space-x-3 p-4 bg-white/60 rounded-lg border border-academy-purple/10 hover:border-academy-purple/30 transition-colors">
                  <div className="bg-academy-purple/20 p-2 rounded-full mt-1">
                    {cert.includes('OFPPT') || cert.includes('ANPME') ? 
                      <MapPin className="w-4 h-4 text-academy-purple" /> : 
                      <Globe className="w-4 h-4 text-academy-purple" />
                    }
                  </div>
                  <div className="flex-1">
                    <p className="font-semibold text-gray-800">{cert}</p>
            ...
            <div className="text-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="text-center">
                  ...
                  <h4 className="font-semibold text-gray-800 mb-2">Reconnaissance Mondiale</h4>
                  <p className="text-gray-600 text-sm">Certifications reconnues par les leaders technologiques internationaux</p>
                </div>
                <div className="text-center">
                  <div className="bg-academy-purple/20 p-4 rounded-2xl w-16 h-16 mx-auto mb-4 flex items-center justify-center">
                    <Globe className="w-8 h-8 text-academy-purple" />
                  </div>
                  <h4 className="font-semibold text-gray-800 mb-2">Opportunités Globales</h4>
                  <p className="text-gray-600 text-sm">Ouvrez les portes vers des carrières internationales</p>
                </div>
                <div className="text-center">
                  <div className="bg-academy-lightblue/20 p-4 rounded-2xl w-16 h-16 mx-auto mb-4 flex items-center justify-center">
                    <MapPin className="w-8 h-8 text-academy-lightblue" />
                  </div>
                  <h4 className="font-semibold text-gray-800 mb-2">Conformité Locale</h4>
                  <p className="text-gray-600 text-sm">Certifications adaptées au marché marocain et maghrébin</p>
                </div>
              </div>
            </div>
          </CardContent>
