...
const AIExcellenceCourse = () => {
  const handleDownload = () => {
    // Use edge function that serves PDF with Content-Disposition: attachment header
    const downloadUrl = 'https://nkkalmyhxtuisjdjmdew.supabase.co/functions/v1/download-brochure?file=Syllabus_Complet.pdf';
