-- ============================================================================
-- COMPREHENSIVE STORAGE SYSTEM ENHANCEMENTS (Fixed)
-- ============================================================================
...
-- 3. DROP AND RECREATE STUDENT-DOCUMENTS STORAGE POLICIES
-- ============================================================================
...
DROP POLICY IF EXISTS "Professors can manage their own materials" ON storage.objects;
...
DROP POLICY IF EXISTS "Admins can view all storage access logs" ON public.storage_access_logs;
DROP POLICY IF EXISTS "Users can view their own storage access logs" ON public.storage_access_logs;
DROP POLICY IF EXISTS "Authenticated users can insert storage access logs" ON public.storage_access_logs;
